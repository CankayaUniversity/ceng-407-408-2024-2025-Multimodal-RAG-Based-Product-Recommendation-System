...
def decode_base64_image(image_base64: str) -> Image.Image:
    ...
    # Assuming the image_base64 string is in the format "data:image/jpeg;base64,..."
...
def rag_pipeline(query_text, category, image_base64=None, memory=None):
    ...
    # If an image is provided, perform multimodal search
    if image_base64:
    ...
    # Build the prompt template for the language model
